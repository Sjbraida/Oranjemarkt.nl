...
const plans: PlanCard[] = [
  {
    ...
    features: ["10 producten", "Live chat met kopers", "Reviews ontvangen", "Eigen winkelpagina"],
    cta: "Start gratis",
    highlight: false,
  },
  {
    ...
    features: ["100 producten", "Statistieken", "Eigen banner", "Volgers verzamelen", "Eigen winkelomgeving"],
    cta: "Kies Kraam",
    highlight: false,
  },
  {
